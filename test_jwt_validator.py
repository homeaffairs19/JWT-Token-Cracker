...
# Example tokens for all three HMAC algorithms
validHS256Token = (
    'eyJhbGciOiAiSFMyNTYiLCAidHlwIjogIkpXVCJ9.eyJzdWIiOiAiMTIzNDU2Nzg5MCIsICJuYW1lIjogIkpvaG4gRG9lIiwgImlhdCI6IDE3MzI3OTQxMzEuOTMxMTEzfQ.eXxi_iUFzcANAz0C_oaBjR_VBBV8ovhtR4wk0qBQPNc'
)
validHS384Token = (
    'eyJhbGciOiAiSFMzODQiLCAidHlwIjogIkpXVCJ9.eyJzdWIiOiAiMTIzNDU2Nzg5MCIsICJuYW1lIjogIkpvaG4gRG9lIiwgImlhdCI6IDE3MzI3OTQxMzEuOTMxMTEzfQ.pUl3hMBQexG844eIQsGp5WlaOjXeqbU9PBNU3UO9rEWp5lypZw17Z2mZZwbuJ5IR'
)
validHS512Token = (
    ' eyJhbGciOiAiSFM1MTIiLCAidHlwIjogIkpXVCJ9.eyJzdWIiOiAiMTIzNDU2Nzg5MCIsICJuYW1lIjogIkpvaG4gRG9lIiwgImlhdCI6IDE3MzI3OTQxMzEuOTMxMTEzfQ.70AWnSvg3reGEMLE4qBlsHaVD8n95oGdfxQnp9Z1XdCNzH9C7Bx_vIFBCsB0hTig2K5eHUPho1GXNA9-MYAV7Q'
)
